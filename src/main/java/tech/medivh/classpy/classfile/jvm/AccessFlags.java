...
import static tech.medivh.classpy.classfile.jvm.AccessFlagType.*;
...
public enum AccessFlags {
    ...
    ACC_INTERFACE   (0x0200, AF_CLASS | AF_NESTED_CLASS            ), ACC_ABSTRACT    (0x0400, AF_CLASS | AF_METHOD | AF_NESTED_CLASS),
